  ...
  const statsData = [
    {
      ...
      totalPoints: 100, academicCount: 1,
      regencyCount: 1, firstPlaceCount: 1,
      isTopAchiever: true,
  ...
  for (const stat of statsData) {
    await prisma.achievementStatistics.upsert({
      ...
      update: {
        ...
        isTopAchiever:     stat.isTopAchiever,
      },
      create: {
        studentId:          stat.studentId,
        ...
        rejectedCount:      stat.rejectedCount,
        totalPoints:        stat.totalPoints,
        academicCount:      (stat as any).academicCount  ?? 0,
        sportsCount:        (stat as any).sportsCount    ?? 0,
        artsCount:          (stat as any).artsCount      ?? 0,
        scienceCount:       0,
        technologyCount:    0,
        nonAcademicCount:   (stat as any).sportsCount ?? (stat as any).artsCount ?? 0,
        schoolCount:        0,
        districtCount:      0,
        regencyCount:       (stat as any).regencyCount   ?? 0,
        provinceCount:      0,
        nationalCount:      0,
